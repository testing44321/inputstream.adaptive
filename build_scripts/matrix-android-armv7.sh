...
./bootstrap
./configure --host=arm-linux-androideabi --with-ndk-api=21 --with-sdk-path=$HOME/tools/android-sdk --with-ndk-path=$HOME/tools/android-ndk --with-toolchain=$HOME/tools/toolchain --disable-debug --prefix=$HOME/tools/kodi-depends
...
### Matrix Version ###
sed -i -E "s/version=\"(.+)\"/version=\"\1-matrix.1\"/" $HOME/kodi/tools/depends/target/binary-addons/inputstream.adaptive/inputstream.adaptive.testing/addon.xml.in.txt
